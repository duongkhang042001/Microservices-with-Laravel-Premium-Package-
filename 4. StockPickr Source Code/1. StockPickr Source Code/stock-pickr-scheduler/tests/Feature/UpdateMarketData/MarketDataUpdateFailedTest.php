...
class MarketDataUpdateFailedTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function it_should_set_schedule_to_failed()
    {
        ...
        event(new MarketDataUpsertFailed(MarketDataUpsertFailedContainer::create('TST', 'Error while updating'), true, $schedule->id));

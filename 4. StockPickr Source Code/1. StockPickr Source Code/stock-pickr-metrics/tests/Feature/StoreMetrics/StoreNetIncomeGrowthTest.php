...
class StoreNetIncomeGrowthTest extends TestCase
{
    use RefreshDatabase;
    ...
    /** @test */
    public function it_should_store_yearly_net_income_growth()
    {
        $company = $this->createCompanyUpsertedContainer([
            'incomeStatements' => [
                'netIncome' => [
    ...
    /** @test */
    public function it_should_store_net_income_growth_as_negative()
    {
        $company = $this->createCompanyUpsertedContainer([
            'incomeStatements' => [
                'netIncome' => [
        ...
        $this->assertEquals(-0.1, round($companyMetric->net_income_growth, 1));
    ...
    /** @test */
    public function it_should_store_net_income_growth_as_null_if_previous_year_negative()
    {
        $company = $this->createCompanyUpsertedContainer([
            'incomeStatements' => [
                'netIncome' => [
    ...
    /** @test */
    public function it_should_store_net_income_growth_as_null_if_previous_year_0()
    {
        $company = $this->createCompanyUpsertedContainer([
            'incomeStatements' => [
                'netIncome' => [

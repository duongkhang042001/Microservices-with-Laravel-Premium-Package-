...
class GetScoresApiTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function it_should_return_200()
    {
        ...
        $response = $this->json('GET', '/api/v1/scores/TST');
    ...
    /** @test */
    public function it_should_return_scores()
    {
        $company = Company::factory(['ticker' => 'TST'])->create();
        CompanyScore::factory([
            'company_id' => $company->id,
        ...
        $data = $this->json('GET', '/api/v1/scores/TST')->json('data');
